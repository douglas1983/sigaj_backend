...
public class Pagamento_Type implements java.io.Serializable {
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pagamento_TypeTIPO TIPO;
    ...
    public Pagamento_Type(short QUANTIDADE_PERMITIDA,
            br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pagamento_TypeTIPO TIPO,
            java.math.BigDecimal VALOR_MINIMO, java.math.BigDecimal VALOR_MAXIMO
     ...
     * @return TIPO
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pagamento_TypeTIPO getTIPO() {
        return TIPO;
    }
     ...
     * @param TIPO
     */
    public void setTIPO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pagamento_TypeTIPO TIPO) {
        this.TIPO = TIPO;
    }
    ...
    // /**
    // * Gets the PERCENTUAL_MINIMO value for this Pagamento_Type.
    // *
    ...
    // /**
    // * Sets the PERCENTUAL_MINIMO value for this Pagamento_Type.
    // *
    ...
    // /**
    // * Gets the PERCENTUAL_MAXIMO value for this Pagamento_Type.
    // *
    ...
    // /**
    // * Sets the PERCENTUAL_MAXIMO value for this Pagamento_Type.
    // *
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Pagamento_Type))
            return false;
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && this.QUANTIDADE_PERMITIDA == other.getQUANTIDADE_PERMITIDA()
                && ((this.TIPO == null && other.getTIPO() == null)
                        || (this.TIPO != null && this.TIPO.equals(other.getTIPO())))
                && ((this.VALOR_MINIMO == null && other.getVALOR_MINIMO() == null)
                        || (this.VALOR_MINIMO != null && this.VALOR_MINIMO.equals(other.getVALOR_MINIMO())))
                && ((this.VALOR_MAXIMO == null && other.getVALOR_MAXIMO() == null)
                        || (this.VALOR_MAXIMO != null && this.VALOR_MAXIMO.equals(other.getVALOR_MAXIMO())))
        // &&
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName(
                "http://caixa.gov.br/sibar/manutencao_cobranca_bancaria/boleto/externo", ">pagamento_Type>TIPO"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
