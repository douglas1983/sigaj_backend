...
public class Servico_saida_negocial_Type  extends br.gov.caixa.sibar.SERVICO_SAIDA_TYPE  implements java.io.Serializable {
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Dados_saida_Type DADOS;
    ...
    public Servico_saida_negocial_Type(
           ...
           br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Dados_saida_Type DADOS) {
        super(
            HEADER,
            COD_RETORNO,
            ORIGEM_RETORNO,
     ...
     * @return DADOS
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Dados_saida_Type getDADOS() {
        return DADOS;
    }
     ...
     * @param DADOS
     */
    public void setDADOS(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Dados_saida_Type DADOS) {
        this.DADOS = DADOS;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caixa.gov.br/sibar/manutencao_cobranca_bancaria/boleto/externo", "servico_saida_negocial_Type"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("DADOS");
        elemField.setXmlName(new javax.xml.namespace.QName("", "DADOS"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://caixa.gov.br/sibar/manutencao_cobranca_bancaria/boleto/externo", "dados_saida_Type"));
