...
public class Titulo_entrada_Type implements java.io.Serializable {
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Titulo_entrada_TypeFLAG_ACEITE FLAG_ACEITE;

    private java.util.Date DATA_EMISSAO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Juros_mora_Type JUROS_MORA;

    private java.math.BigDecimal VALOR_ABATIMENTO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pos_vencimento_Type POS_VENCIMENTO;
    ...
    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Multa_Type MULTA;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Desconto_Type[] DESCONTOS;

    private java.math.BigDecimal VALOR_IOF;

    private java.lang.String IDENTIFICACAO_EMPRESA;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Ficha_compensacao_Type FICHA_COMPENSACAO;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Recibo_pagador_Type RECIBO_PAGADOR;

    private br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pagamento_Type PAGAMENTO;
     ...
     * @return NOSSO_NUMERO
     */
    public java.lang.Long getNOSSO_NUMERO() {
        return NOSSO_NUMERO;
    }
     ...
     * @return FLAG_ACEITE
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Titulo_entrada_TypeFLAG_ACEITE getFLAG_ACEITE() {
        return FLAG_ACEITE;
    }
     ...
     * @return JUROS_MORA
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Juros_mora_Type getJUROS_MORA() {
        return JUROS_MORA;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pos_vencimento_Type getPOS_VENCIMENTO() {
        return POS_VENCIMENTO;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Sacador_avalista_Type getSACADOR_AVALISTA() {
        return SACADOR_AVALISTA;
    }
     ...
     * @return MULTA
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Multa_Type getMULTA() {
        return MULTA;
    }
     ...
     * @return DESCONTOS
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Desconto_Type[] getDESCONTOS() {
        return DESCONTOS;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Ficha_compensacao_Type getFICHA_COMPENSACAO() {
        return FICHA_COMPENSACAO;
    }
     ...
     */
    public br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Recibo_pagador_Type getRECIBO_PAGADOR() {
        return RECIBO_PAGADOR;
    }
     ...
     * @param PAGAMENTO
     */
    public void setPAGAMENTO(br.gov.caixa.sibar.manutencao_cobranca_bancaria.boleto.externo.Pagamento_Type PAGAMENTO) {
        this.PAGAMENTO = PAGAMENTO;
    }
